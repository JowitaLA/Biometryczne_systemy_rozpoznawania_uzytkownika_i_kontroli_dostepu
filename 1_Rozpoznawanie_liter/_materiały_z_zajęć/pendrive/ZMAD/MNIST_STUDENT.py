...
Obsługiwane tryby treningu:
  [1] MNIST + moje cyfry (katalog 'moje_cyfry/')
...
# ============================================================
# 3. Wczytanie własnych cyfr z katalogu "moje_cyfry/"
# ============================================================
...
def load_custom_digits_polish(base_dir: str = "moje_cyfry"):
    """
...
def main():
    ...
    if mode == "1":
        ...
        X_custom, y_custom = load_custom_digits_polish("moje_cyfry")
    ...
    # -------------------------------
        ...
        X_custom, y_custom = load_custom_digits_polish("moje_cyfry")
        if X_custom.shape[0] == 0:
            print("Brak danych w katalogu 'moje_cyfry/'. Nie mogę trenować sieci.")
            return
