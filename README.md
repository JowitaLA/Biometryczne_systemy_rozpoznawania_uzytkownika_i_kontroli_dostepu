...
### Jak uruchomić:
1. Będąc w folderze głównym w terminalu, należy użyć instrukcji: `source .venv/bin/activate`
2. Po aktywowaniu środowiska, należy uruchomić program, używając instrukcji: `python main.py`.